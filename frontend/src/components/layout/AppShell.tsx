...
export const AppShell: React.FC = () => {
  return (
    <div className="flex h-screen bg-surface-900 text-slate-200 overflow-hidden">
      {/* Sidebar */}
      <aside className="w-64 glass-panel flex-shrink-0 flex flex-col border-r border-white/5">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 glass-panel border-b border-white/[0.05] flex items-center justify-between px-6 flex-shrink-0">
